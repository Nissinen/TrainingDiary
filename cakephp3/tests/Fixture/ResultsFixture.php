...
class ResultsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'trainings_result_key' => ['type' => 'index', 'columns' => ['training_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'trainings_result_key' => ['type' => 'foreign', 'columns' => ['training_id'], 'references' => ['trainings', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'created' => '2016-03-19 10:19:33',
            'modified' => '2016-03-19 10:19:33'
        ],
    ];
}
